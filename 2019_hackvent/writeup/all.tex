...
\date{\today}
\title{Hackvent 2019 Writeups}
\maketitle

   \textbf{Note:} These writeups and the underlying files can also be found in this Git repository: \\
   \url{https://github.com/The-Compiler/ctfs/tree/master/2019_hackvent}

I've used \href{https://jupyter.org/}{Jupyter Notebook} to solve the challenges (and add some text). Then, I used Jupyter's LaTeX-export and some hand-editing to end up with this document.
...
If we look at the displayed flag, it starts with \texttt{ØµÎ!}. Encoded
